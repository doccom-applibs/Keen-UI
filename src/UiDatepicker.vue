<template>
  <div class="ui-datepicker" :class="classes">
    ...
    <ui-modal ref="modal" remove-header @close="onPickerClose" @open="onPickerOpen" v-if="usesModal && !disabled">
      <ui-calendar :color="color" :date-filter="dateFilter" :lang="lang" :max-date="maxDate" :min-date="minDate" :orientation="orientation" :value="value" @date-select="onDateSelect">
    ...
    <ui-popover contain-focus ref="popover" trigger="label" :appendTo="appendPopoverTo" @close="onPickerClose" @open="onPickerOpen" v-if="usesPopover && !disabled">
      <ui-calendar :color="color" :date-filter="dateFilter" :lang="lang" :max-date="maxDate" :min-date="minDate" :orientation="orientation" :value="value" @date-select="onDateSelect"></ui-calendar>
    </ui-popover>
  </div>
</template>
