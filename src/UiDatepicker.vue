    ...
    <div class="ui-datepicker" :class="classes">
        ...
        >
            <ui-calendar
                ...
                :init-with-year-picker="initWithYearPicker"
            >
...
export default {
    ...
    computed: {
        ...
        showHelp() {
            return (
                !this.showError &&
                (Boolean(this.help) || Boolean(this.$slots.help))
            );
        },
    ...
    methods: {
        ...
        onBlur(e) {
            ...
            if (
                this.usesPopover &&
                this.$refs.popover.dropInstance.isOpened()
            ) {
        ...
        onPickerOpen() {
            if (this.usesModal) {
                this.valueAtModalOpen = this.value
                    ? dateUtils.clone(this.value)
                    : null;
            }
